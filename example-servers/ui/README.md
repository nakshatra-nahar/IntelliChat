![intelli Chat](../../assets/readme/ui-example.png)

<br>

This is an example [intelli Chat](https://www.npmjs.com/package/intelli-chat) UI project that can be used to communicate with the [example server](https://intellichat.dev/examples/servers) projects.
