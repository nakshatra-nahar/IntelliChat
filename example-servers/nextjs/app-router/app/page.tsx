...
// import {intelliChat as intelliChatCore} from 'intelli-chat'; <- type
import {RequestDetails} from 'intelli-chat/dist/types/interceptors';
import styles from './style.module.css';
import dynamic from 'next/dynamic';

// Info to get a reference for the component:
// https://github.com/OvidijusParsiunas/intelli-chat/issues/59#issuecomment-1839483469

// Info to add types to a component reference:
// https://github.com/OvidijusParsiunas/intelli-chat/issues/59#issuecomment-1839487740

export default function Home() {
  // need to import the component dynamically as it uses the 'window' property
  const intelliChat = dynamic(() => import('intelli-chat-react').then((mod) => mod.intelliChat), {
    ssr: false,
  });
    ...
    <>
      <main className={styles.main}>
        <h1 id={styles.pageTitle}>
          intelli Chat test ground for{' '}
          <a href="https://github.com/OvidijusParsiunas/intelli-chat/tree/main/example-servers/nextjs">NextJs</a>
        </h1>
        ...
        <div className={styles.components}>
          ...
          {/* by setting maxMessages requestBodyLimits to 0 or lower - each request will send full chat history:
            https://intellichat.dev/docs/connect/#requestBodyLimits */}
          {/* If you don't want to or can't edit the target service, you can process the outgoing message using
            ...
            https://intellichat.dev/docs/interceptors */}
          <intelliChat
        ...
        <a href="https://openai.com/blog/openai-api" target="_blank" rel="noreferrer">
          <img
            ...
            src="https://raw.githubusercontent.com/OvidijusParsiunas/intelli-chat/HEAD/website/static/img/openAILogo.png"
        ...
        <div className={styles.components}>
          ...
          {/* If not using the camera, you can use an example image here:
            https://github.com/OvidijusParsiunas/intelli-chat/blob/main/example-servers/ui/assets/example-image.png */}
          <intelliChat
            style={{borderRadius: '10px'}}
            introMessage={{
        ...
        <a href="https://huggingface.co/docs/api-inference/index" target="_blank" rel="noreferrer">
          <img
            className={styles.serverTitleIcon}
            src="https://raw.githubusercontent.com/OvidijusParsiunas/intelli-chat/HEAD/website/static/img/huggingFaceLogo.png"
        ...
        <div className={styles.components}>
          ...
          {/* If not using the microphone, you can send an example audio file here:
            https://github.com/OvidijusParsiunas/intelli-chat/blob/main/example-servers/ui/assets/example-audio.m4a */}
          <intelliChat
            style={{borderRadius: '10px'}}
            introMessage={{
        ...
        <a href="https://platform.stability.ai/" target="_blank" rel="noreferrer">
          <img
            ...
            src="https://raw.githubusercontent.com/OvidijusParsiunas/intelli-chat/HEAD/website/static/img/stabilityAILogo.png"
        ...
        <a href="https://docs.cohere.com/docs" target="_blank" rel="noreferrer">
          <img
            className={styles.serverTitleIcon}
            src="https://raw.githubusercontent.com/OvidijusParsiunas/intelli-chat/HEAD/website/static/img/cohereLogo.png"
