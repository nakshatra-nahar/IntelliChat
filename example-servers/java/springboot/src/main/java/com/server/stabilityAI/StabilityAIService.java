...
public class StabilityAIService {
  ...
  public intelliChatFileResponse textToImage(intelliChatRequestBody requestBody) throws Exception {
    ...
    return new intelliChatFileResponse(Arrays.asList(new intelliChatFile(base64, "image")));
  }
  ...
  public intelliChatFileResponse imageToImage(@RequestPart("files") List<MultipartFile> files, Map<String, String> formDataProperties) throws Exception {
