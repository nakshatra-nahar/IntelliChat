...
Before deploying your application to [Vercel](https://vercel.com/), replace `@sveltejs/adapter-auto` with `@sveltejs/adapter-vercel` in the [`svelte.config.js`](https://github.com/OvidijusParsiunas/intelli-chat/blob/main/example-servers/sveltekit/svelte.config.js) file.
