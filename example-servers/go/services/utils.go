...
func CreateTextResponse(w http.ResponseWriter, text string) ([]byte, error) {
	// Create a response to intelli Chat using the Response format:
	// https://intellichat.dev/docs/connect/#Response
	response := intelliChatTextResponse{
		Text: text,
	}
...
func CreateImageResponse(w http.ResponseWriter, src string) ([]byte, error) {
	// Create a response to intelli Chat using the Response format:
	// https://intellichat.dev/docs/connect/#Response
	response := intelliChatFileResponse{
...
func createErrorResponse(w http.ResponseWriter, text string) ([]byte, error) {
	// Create a response to intelli Chat using the Response format:
	// https://intellichat.dev/docs/connect/#Response
	response := intelliChatErrorResponse{
		Error: text,
	}
