...
func createConversationRequestBodyBytes(w http.ResponseWriter, r *http.Request) ([]byte, error) {
	...
	conversationBody := createConversationBody(intelliChatRequestBody.Messages)
	fmt.Println(conversationBody)
	return json.Marshal(conversationBody)
}

func createConversationBody(messages []intelliChatRequestMessage) HuggingFaceConversationBody {
...
// You can use an example audio here: https://github.com/OvidijusParsiunas/intelli-chat/blob/main/example-servers/ui/assets/example-audio.m4a
