...
type intelliChatRequestBody struct {
	Messages []intelliChatRequestMessage `json:"messages"`
	Model string `json:"model"`
	Stream bool `json:"stream"`
}

type intelliChatRequestMessage struct {
	Role string `json:"role"`
	Text string `json:"text"`
}

type intelliChatTextResponse struct {
	Text string `json:"text"`
}

type intelliChatFileResponse struct {
...
type intelliChatErrorResponse struct {
