  ...
  return (
    ...
    >
      <div className={`start-page-text start-page-large-text ${displayRequest ? 'start-page-main-details-visible' : ''}`}>
        ...
        <a href="https://intellichat.dev/docs/connect#request" target="_blank">
          request
        </a>{' '}
        property:
      </div>
      ...
      >
        The target service needs to be able to handle intelli Chat's{' '}
        <a href="https://intellichat.dev/docs/connect" target="_blank">
          request
        </a>{' '}
        and{' '}
        <a href="https://intellichat.dev/docs/connect#Response" target="_blank">
          response
        </a>{' '}
        formats.
      </div>
      ...
      >
        - Add{' '}
        <a href="https://intellichat.dev/docs/interceptors" target="_blank">
          interceptor
        </a>{' '}
      ...
      >
        - Use a{' '}
        <a href="https://intellichat.dev/docs/connect#Handler" target="_blank">
          handler
        </a>{' '}
