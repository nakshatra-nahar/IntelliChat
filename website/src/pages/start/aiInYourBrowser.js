...
export default function AIInyourBrowser(props) {
  ...
  return (
    ...
    >
      ...
      >
        1. Add the{' '}
        <a href="https://intellichat.dev/docs/webModel" target="_blank">
          intelli-chat-web-llm
        </a>{' '}
        <a href="https://intellichat.dev/examples/externalModules" target="_blank">
          external module
        </a>
        :
      </div>
      ...
      >
        {`import * as webLLM from 'intelli-chat-web-llm'`}
        <br />
