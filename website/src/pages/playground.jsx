...
export default function Playground() {
  ...
  React.useEffect(() => {
    ...
    setTimeout(() => {
      if (localStorage.getItem('intelli-chat-config')) overwriteDefaultConfig();
  ...
  const recordConfig = () => {
    localStorage.setItem('intelli-chat-config', JSON.stringify(playgroundConfig));
  };
  ...
  function overwriteDefaultConfig() {
    Object.assign(playgroundConfig, JSON.parse(localStorage.getItem('intelli-chat-config')));
  }
  ...
  return (
    <Layout title="Playground" description="intelli Chat Playground">
      <Head>
