        ...
        <div className="playgroud-service-modal-form">
          ...
          {activeService === 'custom' && (
            <Required
              ...
              setValue={changeRequiredValue.bind(this, setRequiredValue)}
              title="URL:"
              link={'https://intellichat.dev/docs/connect#Request'}
            />
          )}
...
function getCodeStr(connect, isCustom, view, type) {
  if (connect.demo) {
    return `<intelli-chat demo="true"></intelli-chat>`;
  }
  if (connect.webModel) {
    return `<intelli-chat ${
  ...
  if (isCustom) {
    ...
    return `<intelli-chat${files} request='${JSON.stringify(connect['custom'], null, 2)}'></intelli-chat>`;
  }
  ...
  return `<intelli-chat${files} directConnection='${JSON.stringify(connect, null, 2)}'></intelli-chat>`;
}
...
const REQUIRED_PARAMETERS_LINKS = {
  azure: {
    textToSpeech: 'https://intellichat.dev/docs/directConnection/Azure#TextToSpeech',
    speechToText: 'https://intellichat.dev/docs/directConnection/Azure#SpeechToText',
    summarization: 'https://intellichat.dev/docs/directConnection/Azure#Summarization',
  },
  huggingFace: {
...
const OPTIONAL_PARAM_TO_LINK = {
  demo: {demo: ''},
  custom: {
    method: 'https://intellichat.dev/docs/connect#Request',
    websocket: 'https://intellichat.dev/docs/connect#Websocket',
    headers: 'https://intellichat.dev/docs/connect#Request',
    additionalBodyProps: 'https://intellichat.dev/docs/connect#Request',
    allowImages: 'https://intellichat.dev/docs/files#images',
    allowCamera: 'https://intellichat.dev/docs/files#camera',
    allowGifs: 'https://intellichat.dev/docs/files#gifs',
    allowAudio: 'https://intellichat.dev/docs/files#audio',
    allowMicrophone: 'https://intellichat.dev/docs/files#microphone',
    allowMixedFiles: 'https://intellichat.dev/docs/files/#mixedFiles',
  },
  webModel: {
    model:
      'https://github.com/OvidijusParsiunas/intelli-chat/blob/4449a91e26bb86d1d3a45633fd49c4dead3293d4/component/src/types/webModel/webModel.ts#L1',
    instruction: 'https://intellichat.dev/docs/webModel#webModel',
  },
  openAI: {
    chat: {
      system_prompt: 'https://intellichat.dev/docs/directConnection/OpenAI#Chat',
    ...
    assistant: {
      assistant_id: 'https://intellichat.dev/docs/directConnection/OpenAI#Assistant',
      thread_id: 'https://intellichat.dev/docs/directConnection/OpenAI#Assistant',
      load_thread_history: 'https://intellichat.dev/docs/directConnection/OpenAI#Assistant',
      allowMixedFiles: 'https://intellichat.dev/docs/files/#mixedFiles',
    },
    images: {
  ...
  azure: {
    textToSpeech: {
      ...
      gender: 'https://intellichat.dev/docs/directConnection/Azure#TextToSpeech',
      outputFormat:
    ...
    translation: {
      region: 'https://intellichat.dev/docs/directConnection/Azure#Translation',
      language:
        'https://en.wikipedia.org/wiki/IETF_language_tag#:~:text=An%20IETF%20BCP%2047%20language,the%20IANA%20Language%20Subtag%20Registry.',
    },
  },
