...
<ComponentContainer>
  <intelliChatBrowser style={{backgroundColor: '#f7f7f7', borderRadius: '8px'}} demo={true}></intelliChatBrowser>
</ComponentContainer>
...
```html
<intelli-chat style="background-color: #f7f7f7; border-radius: 8px"></intelli-chat>

<intelli-chat chatStyle='{"backgroundColor": "#f7f7f7", "borderRadius": "8px"}'></intelli-chat>
```
...
<intelli-chat style="background-color: #f7f7f7; border-radius: 8px" demo="true"></intelli-chat>

<intelli-chat chatStyle='{"backgroundColor": "#f7f7f7", "borderRadius": "8px"}' demo="true"></intelli-chat>
```
...
```html
<intelli-chat attachmentContainerStyle='{"backgroundColor": "#b2e1ff57"}'></intelli-chat>
```
...
```html
<intelli-chat inputAreaStyle='{"backgroundColor": "#ebf5ff"}'></intelli-chat>
```
...
<intelli-chat inputAreaStyle='{"backgroundColor": "#ebf5ff"}' style="border-radius: 8px" demo="true"></intelli-chat>
```
