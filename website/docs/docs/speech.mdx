...
<video className="documentation-video" controls>
  <source src="https://github.com/OvidijusParsiunas/intelli-chat/assets/18709577/e103a42e-b3a7-4449-b9db-73fed6d7876e" />
</video>
...
```html
<intelli-chat textToSpeech='{"volume": 0.9}'></intelli-chat>
```
...
```html
<intelli-chat speechToText='{"webSpeech": {"language": "en-US"}}'></intelli-chat>
```
...
:::note
This service stops after a brief period of silence due to limitations in its API and not intelli Chat.
:::
...
```html
<intelli-chat speechToText='{"textColor": {"interim": "green", "final": "blue"}}'></intelli-chat>
```
...
This is the example used in the [demo video](https://github.com/OvidijusParsiunas/intelli-chat/assets/18709577/e103a42e-b3a7-4449-b9db-73fed6d7876e). When replicating - make sure
