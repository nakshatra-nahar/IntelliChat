...
<ComponentContainer>
  <intelliChatBrowser
    ...
    initialMessages={[{files: [{src: '/img/city.jpeg', type: 'image'}], role: 'user'}]}
    demo={true}
    images={true}
  ></intelliChatBrowser>
</ComponentContainer>
...
```html
<intelli-chat images="true"></intelli-chat>
```
...
<intelli-chat
  ...
  introMessage='{"text": "Use the image button or drop a file to attach it to the next outgoing message."}'
  initialMessages='[{"files": [{"src": "path-to-file.jpeg", "type": "image"}], "role": "user"}]'
></intelli-chat>
```
...
<ComponentContainer>
  <intelliChatBrowser
    ...
    initialMessages={[{files: [{src: '/img/example-gif.gif', type: 'image'}], role: 'user'}]}
    demo={true}
    gifs={true}
  ></intelliChatBrowser>
</ComponentContainer>
...
```html
<intelli-chat gifs="true"></intelli-chat>
```
...
<intelli-chat
  ...
  style="border-radius: 8px"
  introMessage='{"text": "Use the GIF button or drop a file to attach it to the next outgoing message."}'
  initialMessages='[{"files": [{"src": "path-to-file.gif", "type": "image"}], "role": "user"}]'
></intelli-chat>
```
...
<ComponentContainer>
  <intelliChatBrowser
    ...
    initialMessages={[{files: [{src: '/img/cat.jpg', type: 'image'}], role: 'user'}]}
    demo={true}
    camera={true}
  ></intelliChatBrowser>
</ComponentContainer>
...
```html
<intelli-chat camera="true"></intelli-chat>
```
...
<ComponentContainer>
  <intelliChatBrowser
    ...
    initialMessages={[{files: [{src: '/audio/cantinaBand.wav', type: 'audio'}], role: 'user'}]}
    demo={true}
    audio={true}
  ></intelliChatBrowser>
</ComponentContainer>
...
```html
<intelli-chat audio="true"></intelli-chat>
```
...
<intelli-chat
  ...
  style="border-radius: 8px"
  introMessage='{"text": "Use the audio button or drop a file to attach it to the next outgoing message."}'
  initialMessages='[{"files": [{"src": "path-to-file.wav", "type": "audio"}], "role": "user"}]'
></intelli-chat>
```
...
<ComponentContainer>
  <intelliChatBrowser
    ...
    initialMessages={[{files: [{src: '/audio/jeff.mp3', type: 'audio'}], role: 'user'}]}
    demo={true}
    microphone={true}
  ></intelliChatBrowser>
</ComponentContainer>
...
```html
<intelli-chat microphone="true"></intelli-chat>
```
...
<ComponentContainer>
  <intelliChatBrowser
    ...
    initialMessages={[{files: [{src: '/text/text.txt', name: 'text-file.txt', type: 'file'}], role: 'user'}]}
    demo={true}
    mixedFiles={true}
  ></intelliChatBrowser>
</ComponentContainer>
...
```html
<intelli-chat mixedFiles="true"></intelli-chat>
```
...
<intelli-chat
  ...
  style="border-radius: 8px"
  introMessage='{"text": "Use the file button or drop a file to attach it to the next outgoing message."}'
  initialMessages='[{"files": [{"src": "path-to-file.txt", "name": "text-file.txt", "type": "file"}], "role": "user"}]'
></intelli-chat>
```
...
```html
<intelli-chat dragAndDrop='{"backgroundColor": "#80ff704d", "border": "5px dashed #52c360"}'></intelli-chat>
```
...
- Type: \{[`request?: Request`](/docs/connect#Request), [`files?: FileAttachments`](#FileAttachments), [`button?: Button`](/docs/styles#Button)\}
...
```html
<intelli-chat images='{"files": {"maxNumberOfFiles": 2, "acceptedFormats": ".jpg,.png"}}'></intelli-chat>
```
...
- Type: \{<br />
  &nbsp;&nbsp;&nbsp;&nbsp; [`request?: Request`](/docs/connect#Request), <br />
