...
Method properties that can be called directly on the intelli Chat element.

:::info
Make sure the intelli Chat component has been fully rendered on the DOM before using these.
:::
