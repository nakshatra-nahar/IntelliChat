...
The following are example backend projects that are preconfigured to work with intelli Chat. Each one includes a variety of endpoints
...
The projects are setup to work with the example [UI project](https://github.com/OvidijusParsiunas/intelli-chat/tree/main/example-servers/ui).
...
[Click for GitHub Project](https://github.com/OvidijusParsiunas/intelli-chat/tree/main/example-servers/node/nestjs)

[Click for GitHub Project](https://github.com/OvidijusParsiunas/intelli-chat/tree/main/example-servers/node/express)
...
[Click for GitHub Project](https://github.com/OvidijusParsiunas/intelli-chat/tree/main/example-servers/java/springboot)
...
[Click for GitHub Project](https://github.com/OvidijusParsiunas/intelli-chat/tree/main/example-servers/go)
...
[Click for GitHub Project](https://github.com/OvidijusParsiunas/intelli-chat/tree/main/example-servers/python/flask)
...
[Click for GitHub Project](https://github.com/OvidijusParsiunas/intelli-chat/tree/main/example-servers/nextjs)
...
[Click for GitHub Project](https://github.com/OvidijusParsiunas/intelli-chat/tree/main/example-servers/sveltekit)

## Troubleshooting

If you are experiencing issueswith any of the examples - please see [**github issues**](https://github.com/OvidijusParsiunas/intelli-chat/issues) or create
