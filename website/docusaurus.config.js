...
const config = {
  ...
  projectName: 'intelli-chat', // repo name
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/OvidijusParsiunas/intelli-chat/tree/main/website',
  ...
  themeConfig:
    ...
    ({
      metadata: [
        ...
        {name: 'og:title', content: 'intelli Chat'},
        {name: 'og:description', content: 'Customizable chat component for AI APIs'},
        {
          name: 'og:image',
          content: 'https://raw.githubusercontent.com/OvidijusParsiunas/intelli-chat/main/assets/readme/social-media-4.png',
        },
        {name: 'og:url', content: 'https://intellichat.dev/'},
        {name: 'twitter:title', content: 'intelli Chat'},
        {name: 'twitter:card', content: 'summary_large_image'},
        {name: 'twitter:site', content: '@intellichat'},
      ...
      navbar: {
        title: 'intelli Chat',
        logo: {
          alt: 'intelli Chat img',
          src: 'img/intelli-chat-title.svg',
          width: 31,
          height: 31,
        },
        items: [
          ...
          {
            href: 'https://github.com/OvidijusParsiunas/intelli-chat',
            position: 'right',
      ...
      algolia: {
        ...
        indexName: 'intellichat',
      },
    }),
  // this is used to prevent the website font changing after it is rendered
  // https://github.com/OvidijusParsiunas/intelli-chat/issues/3
