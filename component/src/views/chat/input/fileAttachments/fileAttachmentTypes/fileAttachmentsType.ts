...
export class FileAttachmentsType {
  ...
  // prettier-ignore
  constructor(intelliChat: intelliChat, fileAttachments: FileAttachments, toggleContainer: (display: boolean) => void,
    ...
    setTimeout(() => {this._validationHandler = intelliChat._validationHandler;});
  }
