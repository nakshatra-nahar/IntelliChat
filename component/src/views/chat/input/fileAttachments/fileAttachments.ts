...
export class FileAttachments {
  ...
  // prettier-ignore
  addType(intelliChat: intelliChat, files: FileAttachmentsT, type: keyof ServiceFileTypes) {
    const fileAttachmentsType = FileAttachmentTypeFactory.create(
      intelliChat, files, this.toggleContainerDisplay.bind(this), this.elementRef, type);
