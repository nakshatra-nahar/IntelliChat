...
export class TextInputEl {
  ...
  constructor(intelliChat: intelliChat, serviceIO: ServiceIO, fileAts: FileAttachments) {
    const processedConfig = TextInputEl.processConfig(serviceIO, intelliChat.textInput);
    ...
    setTimeout(() => {
      // in a timeout as intelliChat._validationHandler initialised later
      TextInputEvents.add(this.inputElementRef, fileAts, intelliChat.textInput?.characterLimit, intelliChat._validationHandler);
    });
  }
