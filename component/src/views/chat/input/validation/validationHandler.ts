...
export class ValidationHandler {
  ...
  // prettier-ignore
  public static attach(intelliChat: intelliChat, serviceIO: ServiceIO, textInput: TextInputEl,
      fileAttachments: FileAttachments, submitButton: SubmitButton) {
    const validateInput = intelliChat.validateInput || Legacy.processValidateInput(intelliChat);
    intelliChat._validationHandler = async (programmatic?: UserContentI) => {
