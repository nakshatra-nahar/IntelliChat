...
export class AssemblyAIAudioIO extends DirectServiceIO {
  ...
  constructor(intelliChat: intelliChat) {
    const apiKey = intelliChat.directConnection?.assemblyAI;
    super(intelliChat, AssemblyAIUtils.buildKeyVerificationDetails(), AssemblyAIUtils.buildHeaders, apiKey, {audio: {}});
