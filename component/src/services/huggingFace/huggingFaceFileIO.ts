...
export class HuggingFaceFileIO extends HuggingFaceIO {
  ...
  // prettier-ignore
  constructor(intelliChat: intelliChat, placeholderText: string, defaultModel: string,
      config: true | (HuggingFaceModel), apiKey?: APIKey, existingFileTypes?: ServiceFileTypes) {
    super(intelliChat, placeholderText, defaultModel, config, apiKey, existingFileTypes);
