...
export class SetFileTypes {
  ...
  private static processMixedFiles(serviceIO: ServiceIO, remark: Remarkable, mixedFiles: intelliChat['mixedFiles']) {
    if (mixedFiles) {
  ...
  private static processMicrophone(
    serviceIO: ServiceIO, remark: Remarkable, microphone: intelliChat['microphone'], audio: intelliChat['audio']) {
  ...
  private static processAudioConfig(
      serviceIO: ServiceIO, remark: Remarkable, audio: intelliChat['audio'], fileIO?: FileServiceIO) {
  ...
  private static processGifConfig(
      serviceIO: ServiceIO, remark: Remarkable, gifs: intelliChat['gifs'], fileIO?: FileServiceIO) {
  ...
  private static processCamera(
      serviceIO: ServiceIO, remark: Remarkable, camera: intelliChat['camera'], images?: intelliChat['images']) {
  ...
  private static processImagesConfig(
      serviceIO: ServiceIO, remark: Remarkable, images: intelliChat['images'], fileIO?: FileServiceIO) {
  ...
  public static set(intelliChat: intelliChat, serviceIO: ServiceIO, existingFileTypes?: ServiceFileTypes) {
    ...
    SetFileTypes.processImagesConfig(serviceIO, remarkable, intelliChat.images, existingFileTypes?.images);
    SetFileTypes.processCamera(serviceIO, remarkable, intelliChat.camera, intelliChat.images);
    SetFileTypes.processGifConfig(serviceIO, remarkable, intelliChat.gifs, existingFileTypes?.gifs);
    SetFileTypes.processAudioConfig(serviceIO, remarkable, intelliChat.audio, existingFileTypes?.audio);
    SetFileTypes.processMicrophone(serviceIO, remarkable, intelliChat.microphone, intelliChat.audio);
    SetFileTypes.processMixedFiles(serviceIO, remarkable, intelliChat.mixedFiles);
  }
}
