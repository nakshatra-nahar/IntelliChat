...
export class RequestUtils {
  ...
  public static async processRequestInterceptor(intelliChat: intelliChat, requestDetails: RequestDetails): InterceptorResultP {
    const result = (await intelliChat.requestInterceptor?.(requestDetails)) || requestDetails;
