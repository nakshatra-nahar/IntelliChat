...
import style from './intelliChat.css?inline';
...
export class intelliChat extends InternalHTML {
  @Property('object')
  connect?: Connect;
  ...
  @Property('function')
  onComponentRender?: (ref: intelliChat) => void;
